...
Run:
  .venv/bin/python "scripts/lighter_pricing_model copy 4.py" --csv logs/gate_activity.csv --horizon-ms 500
"""
...
try:
    ...
    raise SystemExit(
        ...
        "  .venv/bin/python \"scripts/lighter_pricing_model copy 4.py\" ..."
    ) from e
...
def main() -> int:
    ...
    ap.add_argument("--csv", type=str, default="logs/gate_activity.csv")
